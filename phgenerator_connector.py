...
class GeneratorConnector(BaseConnector):
    ...
    def _on_poll(self, param):
        ...
        return self._on_poll_generate_artifacts(config, useinc_filepath, incident_datafile, artifact_datafile,
                    domax_containers, domax_artifacts, start_owner_id, end_owner_id, randomize_event_owners)

    def _on_poll_generate_artifacts(self, config, useinc_filepath, incident_datafile, artifact_datafile,
                            domax_containers, domax_artifacts, start_owner_id, end_owner_id, randomize_event_owners):
        try:
