...
This table lists the configuration variables required to operate Generator. These variables are specified when configuring a Generator asset in Splunk SOAR.
